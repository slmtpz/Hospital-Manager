...
?>
  ...
  <h3>List Future Appointments</h3>
<p>Please specify branch to see future appointments.If you want to see for all of branches, please select 'All'.</p>
<form method="post" action="list_future.php">
Select Report Type
<select name="Branch">
    <option>All</option>
    <?php
